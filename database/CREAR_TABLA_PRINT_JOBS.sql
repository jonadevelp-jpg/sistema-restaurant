-- =====================================================
-- SCRIPT PARA CREAR TABLA DE PRINT_JOBS
-- =====================================================
-- Ejecutar en Supabase SQL Editor
-- Esta tabla es necesaria para el sistema de cola de impresión
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Error: Tabla print_jobs no se creó correctamente';
  END IF;
  
  RAISE NOTICE '✅ Tabla print_jobs creada exitosamente';
END $$;
