-- =====================================================
-- MIGRACIÓN 019: TABLA DE STOCK DE PANES Y BEBIDAS
-- =====================================================
-- Ejecutar en Supabase SQL Editor
-- 
-- Esta tabla gestiona el stock de panes y bebidas
-- Los panes se asocian a categorías del menú (completos, sandwiches)
-- Las bebidas se gestionan independientemente
-- =====================================================
...
-- =====================================================
-- FUNCIÓN PARA DESCONTAR PANES Y BEBIDAS AL CREAR ORDEN
-- =====================================================

-- Modificar la función existente para incluir descuento de panes y bebidas
...
-- Nota: Las bebidas se deben agregar manualmente desde la interfaz admin
